...
export default async function ConversationsPanel() {
  ...
  return (
    <div className="flex flex-col min-w-64 max-w-68 h-full bg-neutral-900 border-x border-zinc-800 relative">
      ...
      <div className="flex flex-col p-3 max-w-68 min-w-64">
        <FriendsNavButton />
        <GuildNavButton />
